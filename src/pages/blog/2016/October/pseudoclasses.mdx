> Warning: This article is VERY dry, don't read on unless you are using it as a quick reference/resource!
...
This selects the `an+b | even | odd`'th child within the scope. where a and b are integers. This can be used to do some really amazing stuff like making a CSS only randomizer using this selector and the Cicada Principle, [Read more here](https://www.lottejackson.com/learning/nth-child-cicada-principle).
